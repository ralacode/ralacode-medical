...
export const examData: Record<number, ExamYearData> = {
  2025: {
    exam: 77,
    pdfs: {
      am: "https://www.mhlw.go.jp/seisakunitsuite/bunya/kenkou_iryou/iryou/topics/dl/tp250428-06a_01.pdf",
      pm: "https://www.mhlw.go.jp/seisakunitsuite/bunya/kenkou_iryou/iryou/topics/dl/tp250428-06b_01.pdf",
      amSupplement:
        "https://www.mhlw.go.jp/seisakunitsuite/bunya/kenkou_iryou/iryou/topics/dl/tp250428-06a_02.pdf",
      pmSupplement:
        "https://www.mhlw.go.jp/seisakunitsuite/bunya/kenkou_iryou/iryou/topics/dl/tp250428-06b_02.pdf",
      answers:
        "https://www.mhlw.go.jp/seisakunitsuite/bunya/kenkou_iryou/iryou/topics/dl/tp250428-06seitou.pdf",
    },
    pageRanges: {
      // 2025年午前 PDF の 1-indexed ページ。表紙・注意のあと、問1は 5 ページ目
      am: [
        [1, 2, 5],
        [3, 5, 6],
        [6, 7, 7],
      ...
      // 2025年午後 PDF の 1-indexed ページ。表紙・注意のあと、問1は 5 ページ目。
      // 問71は 32〜33 ページにまたがるため、#page= は先頭の 32 を登録する
      pm: [
        [1, 3, 5],
        [4, 5, 6],
        [6, 7, 7],
    ...
    bookletPages: {
      // 2025年午前 別冊。表紙のあと No.1（問5）は 5 ページ目。問10は 10〜11 ページ
      am: {
        5: 5,
        6: 6,
        7: 7,
      ...
      // 2025年午後 別冊。表紙のあと No.1（問5）は 5 ページ目。問8は 8〜9 ページ
      pm: {
        5: 5,
        6: 6,
        8: 8,
